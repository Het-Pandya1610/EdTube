...
urlpatterns = [
    ...
    path('save-to-watch-later/<str:video_id>/', views.save_to_watch_later, name='save_to_watch_later'),
    path('remove-from-watch-later/<str:video_id>/', views.remove_from_watch_later, name='remove_from_watch_later'),
    path('watch-later/', views.watch_later_playlist, name='watch_later_playlist'),
